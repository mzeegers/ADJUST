function [y, k_d, A, M, S, T, old_M,x] = SimulatePreps_more_bins(ObjectSize, noise, getBeamTransmissionRatios, syntheticMaterials)
...
incidentSpectrum = incidentSpectrum(20:119);
detectorResponse = detectorResponse(:,20:119);
% Get them under matrix form, consistent with Cai's paper
M = materialAttenuations(20:119,:);
