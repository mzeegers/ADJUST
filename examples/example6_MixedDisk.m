%%% Spectral Tomography
%%% Mixed Disk phantom of size 512 x 512
%%% 5 materials
%%% 100 channels 
%%% Full-view setting: 180 angles from 0 to 180 deg
...
phantom = 'MixedDisk';    % phantom name
...
save([saveDir 'example_MixedDisk.mat'], 'strOut');